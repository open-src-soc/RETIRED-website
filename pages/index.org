...
« /La Semaine RISC-V/ » (The RISC-V Week) brings together two events
from 1 to 3 October 2019 in Paris:
...
- La « /[[#gdr-soc2][Journée RISC-V]] du
  [[http://www.gdr-soc.cnrs.fr][GDR SOC2]]/ » will take place at
  [[https://fr.wikipedia.org/wiki/Campus_de_Jussieu][Jussieu]]:
...
address several important topics:
 ...
 1. The impacts of the arrival of open-source in the design of systems
    on a chip (SoC), embedded systems or cyber-physics (CPS). These
    impacts extend beyond the academic communities and technologies
    into intellectual property (IP) and sovereignty issues.
 2. The identification of points of collaboration between the
    hardware, software, or systems communities.
 3. Facilitating collaboration between academic research and industry.
